...
<html>
	...
	<body>
    <div class="top">Currency Converter</div>
    <div class="col">
        <form method="post" action="currency4.php">
        <div class="col-left">
            <label>Select currency (from):</label>
            <select id="currency1" class="form-control" name="currency_from">
        ...
        <div class="col-right">
            ...
            <select id="currency2" class="form-control" name="currency_to">
                <option  value="AED">United Arab Emirates Dirham (AED)</option>
                <option  value="AFN">Afghan Afghani (AFN)</option>
                <option  value="ALL">Albanian Lek (ALL)</option>
                <option  value="AMD">Armenian Dram (AMD)</option>
        ...
        <div class="col-middle-left">
                ...
                <input class="form-control form-inline" type="text" name="currency_input" autocomplete="off"/>
                <button type="submit" class="button btn btn-default">Convert</button>
        </div>
        <div class="col-middle-right">
                <h4 class="conversionRate"></h4>
                <h3><center>$currency_input $currency_from = $currency $currency_to</center></h3>
        </div>
        </form>
        <div class="col-bottom">
            <h3>1 $currency_from in other currencies:</h3>
